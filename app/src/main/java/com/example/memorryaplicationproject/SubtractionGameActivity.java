...
public class SubtractionGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View view) {
            ...
            if (life == 0){
                ...
                Intent intent = new Intent( SubtractionGameActivity.this, ResultActivity.class);
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(SubtractionGameActivity.this,
